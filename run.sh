...
then
    # Download and install Miniconda (replace Miniconda3-latest-Linux-x86_64.sh with the appropriate file for your system)
...
conda create -n tank-robot-api-env flask python=3.9
